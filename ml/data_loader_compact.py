...
def parse_cmd_line_args():
    parser = argparse.ArgumentParser(
        prog="pytorch-geometric data conversion", description="Symbolic execution"
    )
...
def get_data_hetero_vector():
    dl = ServerDataloaderHeteroVector("../../GNN/all")
    # dl = ServerDataloaderHetero("../../GNN/Serialized_test")
    return dl.dataset
